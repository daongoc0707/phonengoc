...
public:
    ...
    // Rewrites future outgoing socket/datagram destinations for this registry.
    // Listener/bind endpoints and HTTP(S) requests are intentionally unchanged.
    [[nodiscard]] Status set_endpoint_override(
...
private:
    ...
    std::optional<Endpoint> endpoint_override_;
    i32 owner_ {0};
    i32 next_id_ {1};
